...
*/
contract BancorConverter3 is IBancorConverter, SmartTokenController, Managed, ContractIds, FeatureIds {
    ...
    */
    ...
    modifier validConnectorWeight(uint32 _weight) {
        require(_weight > 0 && _weight <= MAX_WEIGHT, "Connector Weight is invalid");
        _;
    }
