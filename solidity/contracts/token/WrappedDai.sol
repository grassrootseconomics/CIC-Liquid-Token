...
/**
    @dev xDAI tokenization contract, copy of EtherToken code with renames for the xDai POA Chain

    'Owned' is specified here for readability reasons
*/
contract WrappedDai is IEtherToken, Owned, ERC20Token, TokenHolder {
